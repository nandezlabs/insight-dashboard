...
```bash
bash ~/Desktop/workspace/setup-mac-dev.sh
```
...
**Backup Location**: `~/Desktop/workspace/vscode-backup/`
...
```bash
~/Desktop/workspace/create-project.sh
```
...
```bash
workspace        # cd ~/Desktop/workspace
insight          # cd ~/Desktop/workspace/Insight
...
- [ ] Run `~/Desktop/workspace/manage-vscode.sh` → Backup
- [ ] Commit all Git changes
- [ ] Push all repos to GitHub
- [ ] Export browser bookmarks
- [ ] Backup `~/Desktop/workspace/` folder
...
```bash
# Run manually:
bash ~/Desktop/workspace/vscode-backup/install-extensions.sh
```
