...
rclone_migration() {
    ...
    if rclone listremotes | grep -q "icloud:"; then
        ...
        rclone copy icloud: /Volumes/cloud/ \
            ...
            --checkers 8 \
            --stats 30s \
            --log-file ~/Desktop/workspace/icloud-migration.log &
    ...
    if rclone listremotes | grep -q "gdrive:"; then
        ...
        rclone copy gdrive: /Volumes/cloud/Photos/Library/ \
            ...
            --checkers 8 \
            --stats 30s \
            --log-file ~/Desktop/workspace/gdrive-migration.log &
    ...
    echo "  tail -f ~/Desktop/workspace/icloud-migration.log"
    echo "  tail -f ~/Desktop/workspace/gdrive-migration.log"
    echo ""
